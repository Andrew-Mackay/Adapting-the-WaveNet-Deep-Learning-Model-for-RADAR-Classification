...
# # Training vgg16 transfer learned model on all users except one then testing on that user. 
...
# *   All movements
# *   VGG16 transferred learned model
# *   Datsets:
#     * 1: Miss out A
#     * 2: Miss out B
#     * 3: Miss out C
...
#     
#     
# Learning rate adjusted from 0.01 to 0.0001 compared to base model
...
MODELS_PATH = BASE_PATH + 'models/transferred_DCNN/leave_one_user_out/'
RESULTS_PATH = BASE_PATH + 'results/transferred_DCNN/leave_one_user_out/'
REPORT_PATH = BASE_PATH + 'reports/transferred_DCNN/leave_one_user_out/'
